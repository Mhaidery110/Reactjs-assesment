...
app.post("/post", (req, res)=>{
    ...
    const q = "INSERT INTO personal (`name`, `dob`, `sex`, `mobile`, `idNumber`, `govId`,`glabel`,`gaurdian`, `gemail`, `gcontact`,`address`, `city`, `state`, `country`, `pin`, `occ`, `religion`, `marital`, `blood`, `nation` ) VALUES(?)"
    const VALUES = [name, dob, sex, mobile, idNumber, govId, glabel, gaurdian, gemail, gcontact, address, city, state, country, pin, occ, religion, marital, blood, nation];
